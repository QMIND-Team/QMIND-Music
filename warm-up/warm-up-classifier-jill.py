...
def songAnalysis(song):
    ...
    fields = ['danceability', 'energy', 'key', 'mode',
    ...
    # only add the data from certain columns of the row !!!!!
    features.append(dataArray[0:3])
    # want 0 1 2 4 5 7 9
    ...
    print(
        f'I predict this song is a {clf.predict(features)} with {accuracy} % accuracy.')
